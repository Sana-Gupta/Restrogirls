		      ...
		      <ul class="right hide-on-med-and-down">
		        ...
		        <?php
		        	...
		        	if (isset($_SESSION['user'])) {
		        		...
		        		<li><a href="logout.php" class="aves-effect waves-light btn modal-trigger">Logout</a></li>';
		        	} else {
		        		echo '<li><a href="#" class="hvr-grow modal-trigger" data-target="modal1">Login</a></li>
		        		<li><a href="#modal1" class="waves-effect waves-light btn modal-trigger" data-target="modal2">Register</a></li>';
		        	}
