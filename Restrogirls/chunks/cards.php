<section class="fcards">
		<div class="row" style="padding-left: 50px; padding-right: 50px;">
			...
			<div class="col s12 m12 l4" style="padding: 50px 5px;">
				<div class="card hoverable">
				    ...
				    <div class="card-content">
				      <span class="card-title activator grey-text text-darken-4"><strong>Chinese</strong><i class="material-icons right">more_vert</i></span>
				      <div class="card-content">
			...
			<div class="col s12 m12 l4" style="padding: 50px 5px;">
				<div class="card hoverable">
				    ...
				    <div class="card-content">
				      <span class="card-title activator grey-text text-darken-4"><strong>North Indian</strong><i class="material-icons right">more_vert</i></span>
				      <div class="card-content">
			          <p>Wanna check out the Mouth-Watering Foods of this category ? Explore Now!</p>
			        </div>
				    </div>
			...
			<div class="col s12 m12 l4" style="padding: 50px 5px;">
				<div class="card hoverable">
				    ...
				    <div class="card-content">
				      <span class="card-title activator grey-text text-darken-4"><strong>South Indian</strong><i class="material-icons right">more_vert</i></span>
				      <div class="card-content">
			          <p>Wanna check out the Mouth-Watering Foods of this category ? Explore Now!</p>
			        </div>
				    </div>
		...
		<div class="row center" style="margin-bottom: 50px;">
			<div class="col s12">
				<a href="food-categories.php" class="waves-effect waves-light btn" style="background: blue lighten-1 !important;">More Foods &raquo;</a>
			</div>
		</div>
	</section>