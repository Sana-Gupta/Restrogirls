<section class="loginmodal">
	<div id="modal1" class="modal">
	    <div class="modal-content center">
		  ...
		  <a href="javascript:void(0)" class="modal-close waves-effect waves-light btn" id="login_btn" style="background: blue lighten-1 !important;">Login <i class="material-icons right">send</i></a>
