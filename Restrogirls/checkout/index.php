...
<head>
	<meta charset="UTF-8">
	<title>Safarnama Cafe - The Perfect Food at Your Door!</title>
...
<script>  // Or with jQuery

  $(document).ready(function(){
    $('.carousel').carousel();
    $('input#password_reg').characterCounter();
    $('input#con_password_reg').characterCounter();
  });
